...
fichas_subp <- fichas_subp %>% 
  ...
  select(subprefeitura, acao_orcamentaria, descricao_proj_ativ, liq_pdm, liq_oc, liq_op, liq_23, liq_da)
...
readr::write_csv2(fichas_subp, "fichas_subp.csv")
