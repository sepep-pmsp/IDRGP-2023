...
ggplot(comparacao_long, aes(x = subprefeitura, y = valor, fill = idrgp)) +
  ...
  geom_line(data = comparacao_long, aes(x = subprefeitura, y = valor_esperado, group = subprefeitura), color = "orange", linetype = "dashed", size = 0.25) +
  labs(x = NULL, y = NULL, fill = NULL) +
  facet_wrap(~subprefeitura, scales = "free_x") + 
  theme_minimal() +
