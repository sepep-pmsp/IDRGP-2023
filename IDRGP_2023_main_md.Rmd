...
# juntar todas as subprefeituras para todas as dotações
...
# acrescentar na base_da_pdm, valor registrado no SMAE
...
b %>% 
  filter(str_length(dotacao) < 48) #14 situações
...
#3 14.10.16.482.3005.3.355.44905100.00  #neste caso, há 7 dotações com valores para 4 subprefeituras
base_da_pdm %>% 
...
#9 86.14.16.451.3002.3.357.44903900.03
#10 91.10.16.482.3002.3.356.44903900.08.1.759.8011
#11 16.10.12.361.3010.3.365.44905100.00.1.500.0003
#12 98.22.26.453.3009.5.105.44903900.08
#13 98.22.26.453.3009.5.105.44905100.08
#14 25.10.13.392.3001.6.371.3390

base_da_pdm %>% 
  filter(dotacao == "14.10.16.451.3002.3.357.44903900.00")
