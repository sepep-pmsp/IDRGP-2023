...
dotacao <- c(rep("dot1", 21), rep("dot2", 21), rep("dot3", 21))
regiao <- c(rep("norte", 5), rep("sul", 5), rep("leste", 6), rep("oeste", 3), rep("centro", 2),
            rep("norte", 5), rep("sul", 5), rep("leste", 6), rep("oeste", 3), rep("centro", 2),
            rep("norte", 5), rep("sul", 5), rep("leste", 6), rep("oeste", 3), rep("centro", 2))
subprefeitura <- c("santa", "pirituba", "perus", "jaçana", "supra_norte", "capela do socorro",
                   "cidade ademar", "vila mariana", "parelheiros", "supra_sul",
                   "itaquera", "ermelino", "aricanduva", "mooca", "itaim paulista", "supra_leste",
                   "butanta", "lapa", "supra_oeste", "sé", "supra_centro", "santa", "pirituba", "perus",
                   "jaçana", "supra_norte", "capela do socorro",
                   "cidade ademar", "vila mariana", "parelheiros", "supra_sul",
                   "itaquera", "ermelino", "aricanduva", "mooca", "itaim paulista", "supra_leste",
                   "butanta", "lapa", "supra_oeste",
                   "sé", "supra_centro", "santa", "pirituba", "perus", "jaçana", "supra_norte", "capela do socorro",
                   "cidade ademar", "vila mariana", "parelheiros", "supra_sul",
                   "itaquera", "ermelino", "aricanduva", "mooca", "itaim paulista", "supra_leste",
                   "butanta", "lapa", "supra_oeste",
                   "sé", "supra_centro")
...
media_por_grupo <- dados %>%
  filter(str_detect(subprefeitura, "supra")) %>% 
  group_by(dotacao, regiao) %>% 
  summarise(valor_sub = valor / n_distinct(subprefeitura))

dados <- dados %>%
  left_join(media_por_grupo, by = c("dotacao", "regiao"))

dados <- dados %>%
  mutate(rateio = ifelse(subprefeitura %in% c("supra_norte", "supra_sul", "supra_leste", "supra_oeste", "supra_centro"),
                         valor / n_distinct(subprefeitura) * media_valor, valor))
