...
idrgp %>% 
  ...
  scale_fill_gradient(low="white",high="#0ea1cf") +
...
fichas_subp <- fichas_subp %>% 
  ...
  select(subprefeitura, acao_orcamentaria, descricao_proj_ativ, liq_da_sub, liq_23, liq_pdm, liq_oc, liq_op, liq_da)
...
fichas_subp <- fichas_subp %>% 
  select(subprefeitura, liq_da_sub, ref_idrgp, posicao_ranking, liq_idrgp_22, liq_idrgp_23, liq_idrbp_acum, status, acao_orcamentaria, descricao_proj_ativ, liq_23, liq_da, liq_pdm, liq_oc, liq_op) %>% 
