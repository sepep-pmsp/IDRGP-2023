...
#1 14.10.16.451.3002.3.357.44903900.00
base_da2 %>% 
  filter(str_detect(dotacao, "^14\\.10\\.16\\.451\\.3002\\.3\\.357\\.44903900\\.00")) # para identificar quantas dotações estão compreendidas na dotação incompleta
...
(a <- base_da2 %>% 
  ...
  mutate(total_valor = sum(valor_liquidado),
         prop = valor_liquidado / total_valor)) # para calcular a proporção de cada dotação completa no conjunto abrangido pela dotação incompleta
